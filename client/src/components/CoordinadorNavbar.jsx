...
export default function CoordinadorNavbar({ user, currentTab, onSelectTab, onLogout }) {
  ...
  const tabs = [
    ...
    { id: 'asistencia', label: 'Mi Asistencia', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`hidden sm:flex flex-col text-right px-2.5 py-1 rounded-xl transition-all cursor-pointer ${
                currentTab === 'perfil'
                  ? 'bg-[#A60809]/10 text-[#810404] ring-1 ring-[#A60809]/30'
                  : 'hover:bg-gray-100'
              }`}
              title="Ver y editar mis datos personales y credenciales"
            >
